...
use D4Sign\D4Sign;
use D4Sign\Signatory\UpdateSignatoryEmailFields;
...
try {
    $fields = new UpdateSignatoryEmailFields(
        'emailantigo@email.com',
        'emailnovo@email.com',
        '{key-signer}' // Código é encontrado listando os signatários de um documento.
    );
